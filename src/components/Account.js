  ...
  useEffect(()=>{
    ...
    return (
        <div className="screen">
          ...
          <div className="center-hrz u-margin-top u-margin-bottom-big">
             <button className="button" onClick={()=>firebase.auth().signOut()}>Sign Out</button>
          </div>

          <div className="center-hrz u-margin-bottom-huge" style={{justifyContent: "space-evenly"}}>
            <button className="article__social__button  article__social__button--insta" onClick={()=>{
              openModal();
              setSite("instagram");
            }}><img src={Instagram} alt="" class="article__social__icon" />Add</button>

            <button className="article__social__button" onClick={()=>{
              openModal();
              setSite("twitter");
            }}><img src={Twitter} alt="" className="article__social__icon"/>Add</button>
            <button className="article__social__button" onClick={()=>{
              openModal();
              setSite("facebook");
            }}><img src={Facebook} alt="" className="article__social__icon"/>Add</button>
         </div>
         ...
         <div className="modal"  ref={modalRef}>
              ...
              <form onSubmit={handleSubmit}>
                <div className="input-group center-hrz--col">
                  <input type="text" name="text" id="link" className="input-textbox" placeholder={`${site} Link`} onChange={handleChange}  required/>
                  <label htmlFor="link" className="input--label" style={{textTransform: "capitalize"}}>{site} Link</label>
                </div>
